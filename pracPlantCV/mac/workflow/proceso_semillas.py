...
def main():
    ...
    #pcv.outputs.add_observation(sample='other', variable='nsemillas',
    ...
    for i in range(0, number_seeds):
        ...
        if obj_hierarchy[0][i][3] == -1:
            ...
            shape_img = pcv.analyze_object(img=shape_img, obj=seed, mask=seed_mask)
